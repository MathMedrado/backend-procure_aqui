...
'''class SupermarketInline(admin.StackedInline):
...
class ProductAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name',) #cria uma pesquisa
    list_filter = ('category',) #filtra
...
#admin.site.register(ProductSupermarket)
